...
class NavigationDrawerWidget extends StatelessWidget{
  ...
  List <String> items =[
    "Search","Edit Profile","Logout"
  ];
  List <Icon> ic =[
    Icon(Icons.search,color: Colors.orange[400],),Icon(Icons.edit,color: Colors.orange[400],),Icon(Icons.logout,color: Colors.orange[400],)
  ];
  List routes = [
    Search1(),Edit(user.uid),"new AuthMethods().signOut()"
  ];
...
Widget buildHeader()
{
  ...
  return Row(children: [
    Container(child:image.toString()!=null?Icon(Icons.person_outline_sharp):Image.network(image.toString(),height: 30,width: 30,)),
    SizedBox(height: 10,),
    Container(
